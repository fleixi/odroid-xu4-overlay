...
SRC_URI="https://github.com/rust-lang/cargo/archive/${PV}.tar.gz -> ${P}.tar.gz
	...
	arm? (
                https://static.rust-lang.org/cargo-dist/${CARGO_SNAPSHOT_DATE}/cargo-nightly-armv7-unknown-linux-gnueabihf.tar.gz ->
                cargo-snapshot-arm-${CARGO_SNAPSHOT_DATE}.tar.gz
        )"
...
DEPEND="${COMMON_DEPEND}
	|| ( >=dev-lang/rust-1.9.0:stable >=dev-lang/rust-bin-1.9.0 )
	dev-util/cmake
	sys-apps/coreutils
	sys-apps/diffutils
	sys-apps/findutils
...
src_configure() {
	...
	use arm && CTARGET="armv7-unknown-linux-gnueabihf"
