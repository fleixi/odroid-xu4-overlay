...
LICENSE="GPL-2+"
SLOT="0"
IUSE="+colord +cups debug input_devices_wacom -openrc-force networkmanager policykit smartcard test +udev wayland half_volume_step"
REQUIRED_USE="
...
src_prepare() {
	...
	use half_volume_step && eapply "${FILESDIR}"/${PN}-volumestep.patch
	eautoreconf
	gnome2_src_prepare
}
