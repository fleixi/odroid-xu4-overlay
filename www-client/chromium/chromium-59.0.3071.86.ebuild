...
IUSE="component-build cups gconf gnome-keyring +gtk3 +hangouts kerberos neon pic proprietary-codecs pulseaudio selinux +suid +system-ffmpeg +system-libvpx +tcmalloc widevine +odroid_xu4"
...
#		"${FILESDIR}/disable-cross-compile.patch"
...
src_configure() {
	...
	# odroid Xu4 custom.
	if use odroid_xu4; then
		myconf_gn+=" ignore-gpu-blacklist"
		myconf_gn+=" use-gl=osmesa"
		mycong_gn+=" disable-gpu-compositing"
		mycong_gn+=" num-raster-threads=6"
		mycong_gn+=" force-gpu-rasterization"
	fi
